...
const specialEvents: Record<string, Partial<ResultEventLogEntry>> = {
  ...
  [eventId(7, "night")]: {
    ...
    narration: "デコピンに急かされることなく、二人はそれぞれの意志でこれからも隣にいたいと伝えた。",
...
const narrativeDays = [
  ...
  ["提案がなくても生まれる時間", "二人から誘いや相談が増え、デコピンはきっかけを置かず見守る場面が増えていった。", eventId(6, "night")],
  ...
  result: {
    ...
    producer: {
      ...
      highlights: [
        ...
        { id: "highlight-repair", kind: "conflict_repaired", headline: "二人の言葉でほどいた結び目", reason: "デコピンへの指示どおりではなく、それぞれの言葉で関係を修復しました。", eventLogIds: [eventId(5, "evening")], memoryId: "memory-repair" },
    ...
    narrative: {
      ...
      lead: [{ text: "デコピンがしたのは、二人を動かすことではなく、選べるきっかけを置くことでした。断る自由と話し直す時間が、七日間を二人自身の物語に変えていきます。", sourceEventLogIds: [eventId(1, "evening"), eventId(3, "night"), eventId(5, "evening")] }],
